...
{
    public class BaseUserTeamCommandValidator : AbstractValidator<BaseUserTeamCommandModel>
    {
        protected readonly AppDbContext _appDbContext;

        protected readonly UserManager<User> _userManager;

        public BaseUserTeamCommandValidator(AppDbContext appDbContext, UserManager<User> userManager)
        {
        ...
        private async Task<bool> DoesTeamExistAsync(BaseUserTeamCommandModel command)
        {
